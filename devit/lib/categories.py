...
ATTACH_GALLERY = "full_gallery_dataset"
COCO_PLUS_ATTACH = "coco_plus_attach"

IKEA_GALLERY = "full_gallery_dataset_ikea"
COCO_PLUS_IKEA = "coco_plus_ikea"
...
SEEN_CLS_DICT = {
    ...
    COCO_PLUS_ATTACH: fs_coco_2014_seen_classes,
    COCO_PLUS_IKEA: fs_coco_2014_seen_classes
}
...
ALL_CLS_DICT = {
    ...
    ATTACH_GALLERY: ["Screwdriver", "Leg", "WallSpacerTop", "ScrewNoHead", "Wrench", "Board", "ScrewWithHead", "ThreadedTupeFemale", "ThreadedRod", "Manual", "Hammer", "WallSpacerMounting"],
    COCO_PLUS_ATTACH: fs_coco_2014_seen_classes + ["Screwdriver", "Leg", "WallSpacerTop", "ScrewNoHead", "Wrench", "Board", "ScrewWithHead", "ThreadedTupeFemale", "ThreadedRod", "Manual", "Hammer", "WallSpacerMounting"],

    IKEA_GALLERY: ['table_top-black', 'table_top-white', 'table_top-oak', 'leg-black', 'leg-white', 'leg-oak', 'shelf-black', 'shelf-white', 'shelf-oak', 'front_panel-black', 'front_panel-white', 'front_panel-oak', 'side_panel', 'bottom_panel', 'rear_panel'],
    COCO_PLUS_IKEA: fs_coco_2014_seen_classes + ['table_top-black', 'table_top-white', 'table_top-oak', 'leg-black', 'leg-white', 'leg-oak', 'shelf-black', 'shelf-white', 'shelf-oak', 'front_panel-black', 'front_panel-white', 'front_panel-oak', 'side_panel', 'bottom_panel', 'rear_panel']
}
