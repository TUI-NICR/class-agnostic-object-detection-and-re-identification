...
def make_query_dataset_with_masks(filter_imgs=None):
    def return_func():
        P = "/path/to/attach-benchmark/queries_detectron"
        P_GT = "/path/to/attach-benchmark/queries_detectron.json"
...
def main(inp, 
    ...
    #with open("/path/to/attach-benchmark/table_all_with_class.json", "r") as f:
