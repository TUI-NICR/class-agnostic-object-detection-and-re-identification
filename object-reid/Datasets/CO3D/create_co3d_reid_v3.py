...
os.makedirs("co3d_reid_v3", exist_ok=True)
all_samples["train"].to_csv("co3d_reid_v3/train.csv", index=False)
all_samples["test"].to_csv("co3d_reid_v3/test.csv", index=False)
all_samples["query"].to_csv("co3d_reid_v3/query.csv", index=False)
